...
const char vowels[] = "aeiouáéíóúüAEIOUÁÉÍÓÚÜ";
const char ynchars[] = "yn", es_ynchars[] = "sn";
const char ynqchars[] = "ynq", es_ynqchars[] = "snd";
const char ynaqchars[] = "ynaq", es_ynaqchars[] = "sntd";
const char ynNaqchars[] = "yn#aq", es_ynNaqchars[] = "sn#td";
...
/* LENGUA:  Don't forget to call feminize()! */
NEARDATA struct c_color_names c_color_names = {
	"negro", "ámbar", "áureo",
	"azul claro", "rojo", "verde",
	"plateado", "azul", "púpura",
	"blanco"
};
...
const char *c_obj_colors[] = {
	...
	"cian",			/* CLR_CYAN */
	"gris",			/* CLR_GRAY */
	"transparente",		/* no_color */
	"anaranjado",		/* CLR_ORANGE */
	"verde brillante",	/* CLR_BRIGHT_GREEN */
	"amarillo",		/* CLR_YELLOW */
	"azul brillante",	/* CLR_BRIGHT_BLUE */
	"magenta brillante",	/* CLR_BRIGHT_MAGENTA */
	"cian brillante",	/* CLR_BRIGHT_CYAN */
	"blanco",		/* CLR_WHITE */
};

struct c_common_strings c_common_strings = {
	"No pasa nada.",		"¡Basta por ahora!",
	"Eso es una cosa tonta para %s.",	"Temblas por un momento.",
	"algo", "Algo", "Puedes moverte de nuevo.", "No importa.",
	"Tu visión se aclara pronto.", {"el", "tu"}
};

/* NOTE: the order of these words exactly corresponds to the
   order of oc_material values #define'd in objclass.h. */
const char *materialnm[] = {
	"misterioso", "líquido", "de cera", "orgánico", "de carne",
	"de papel", "de tela", "de cuero", "de madera", "de hueso",
	"de cuero de dragón", "de hierro", "de metal", "de cobre", "de plata",
	"de oro", "de platino", "de mithril", "de plástico", "de vidrio",
	"de piedra preciosa", "de piedra"
};
