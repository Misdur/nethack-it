...
static const char * const shktools[] = {
    ...
    "Nosah-cyar", "Reviaj", "Onacsal Serdna",
#ifdef OVERLAY
...
const struct shclass shtypes[] = {
	{"tienda general", RANDOM_CLASS, 44,
	    D_SHOP, {{100, RANDOM_CLASS}, {0, 0}, {0, 0}}, shkgeneral},
	{"mercado de armaduras usadas", ARMOR_CLASS, 14,
	    D_SHOP, {{90, ARMOR_CLASS}, {10, WEAPON_CLASS}, {0, 0}},
	     shkarmors},
	{"librería de segunda mano", SCROLL_CLASS, 10, D_SHOP,
	    {{90, SCROLL_CLASS}, {10, SPBOOK_CLASS}, {0, 0}}, shkbooks},
	{"emporio de licores", POTION_CLASS, 10, D_SHOP,
	    {{100, POTION_CLASS}, {0, 0}, {0, 0}}, shkliquors},
	{"mercado de armas antiguas", WEAPON_CLASS, 5, D_SHOP,
	...
	{"joyería", RING_CLASS, 3, D_SHOP,
	    {{85, RING_CLASS}, {10, GEM_CLASS}, {5, AMULET_CLASS}, {0, 0}},
	    shkrings},
	{"ropa y accesorías de calidad", WAND_CLASS, 3, D_SHOP,
	    {{90, WAND_CLASS}, {5, -LEATHER_GLOVES}, {5, -ELVEN_CLOAK}, {0, 0}},
	     shkwands},
	{"ferretería", TOOL_CLASS, 3, D_SHOP,
...
register struct mkroom *sroom;
{
    ...
    if(levl[sx][sy].doormask == D_LOCKED) {
	    ...
	    Sprintf(buf, "Cerrada por inventario");
